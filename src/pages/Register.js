...
export const Register = () => {
    ...
    async function handleRegister(event) {
        ...
        try {
            ...
            toast.error('Register Page Broken', { position: "bottom-center", })
        }
    }
